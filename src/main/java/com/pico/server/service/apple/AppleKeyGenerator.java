...
import com.pico.server.dto.apple.ApplePublicKey;
import com.pico.server.dto.apple.ApplePublicKeyResponse;
...
public class AppleKeyGenerator {
    ...
    @Value("${apple.url.public-keys}")
    private String applePublicKeysUrl;
    @Value("${apple.app.keyId}")
    private String kid;
    @Value("${apple.app.teamId}")
    private String teamId;
    @Value("${apple.app.id}")
    private String appId;
    @Value("${apple.app.privateKey}")
